...
export class PageSelectorComponent {
  // In changesView pages$ e' gia' filtrato per fase/strato a monte (text-panel
  // -> evtPagesOverride$), quindi il selettore mostra solo le carte disponibili,
  // coerentemente con slider/frecce/miniature.
